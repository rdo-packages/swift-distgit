...
sed -i '/\/usr\/bin\/env python/{d;q}' %{buildroot}%{python2_sitearch}/swift/test/probe/test_object_partpower_increase.py
sed -i '/\/usr\/bin\/env python/{d;q}' %{buildroot}%{python2_sitearch}/swift/test/functional/test_symlink.py
