...
install -p -D -m 640 etc/container-sharder.conf-sample %{buildroot}%{_sysconfdir}/swift/container-sharder.conf
...
%config(noreplace) %attr(640, root, swift) %{_sysconfdir}/swift/container-sharder.conf
%config(noreplace) %attr(640, root, swift) %{_sysconfdir}/swift/container-sharder.conf
